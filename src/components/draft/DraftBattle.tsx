            ...
            <div className="text-center flex-1" style={{ animation: 'slideFromRight 0.5s ease-out' }}>
              ...
              <div className="flex flex-wrap justify-center gap-2">
                {p2Slots.map((s: any, i: number) => (
                  <div key={i} className="w-14 h-14 sm:w-18 sm:h-18 rounded-lg overflow-hidden border-2 border-red-500/30 shadow-lg shadow-red-500/10"
                    style={{ animation: `popIn 0.3s ease-out ${i * 0.1}s both` }}>
                    <img src={s.hero.img} alt="" className="w-full h-full object-cover" />
                  </div>
                ))}
        ...
        {stage === 'clash' && (
          <div className="space-y-3" style={{ animation: 'fadeIn 0.4s ease-out' }}>
            ...
            {[0, 1, 2, 3, 4].map(i => {
              ...
              return (
                <div key={i} className={`flex items-center gap-3 p-3 rounded-xl transition-all duration-500 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
                  ...
                  <div className="flex items-center gap-2 flex-1 justify-end">
                    ...
                    <img src={h1.icon} alt="" className="w-10 h-10 rounded-lg border border-emerald-500/30" />
                  </div>
                  {/* Position badge */}
                  ...
                  <div className="flex items-center gap-2 flex-1">
                    <img src={h2.icon} alt="" className="w-10 h-10 rounded-lg border border-red-500/30" />
          ...
          <div className="text-center space-y-8" style={{ animation: 'fadeIn 0.6s ease-out' }}>
            ...
            <div className="max-w-md mx-auto" style={{ animation: 'fadeIn 0.5s ease-out 0.8s both' }}>
              ...
              <div className="h-3 rounded-full bg-white/5 overflow-hidden flex">
                ...
                <div className="h-full bg-gradient-to-r from-red-400 to-red-500 transition-all duration-1000 rounded-r-full" style={{ width: `${analysis.player2Score}%` }} />
              </div>
            </div>
