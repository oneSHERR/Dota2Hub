    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center px-4">
        <div className="text-center">
          ...
          <Link to="/auth" className="inline-flex items-center gap-2 px-6 py-3 rounded-2xl bg-dota-accent text-white font-body font-bold text-sm hover:bg-red-600 transition-all duration-300">
      ...
      <div className="max-w-2xl mx-auto py-12 px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <button
            ...
            className="group rounded-2xl bg-dota-card/60 border border-white/8 p-8 text-center hover:border-emerald-500/20 transition-all duration-300"
          >
          ...
          <button
            ...
            className="group rounded-2xl bg-dota-card/60 border border-white/8 p-8 text-center hover:border-purple-500/20 transition-all duration-300"
          >
