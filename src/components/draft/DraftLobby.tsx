    ...
    return (
      <div className="max-w-lg mx-auto py-12">
        <div className="rounded-2xl bg-[#111827] border border-white/8 p-8 text-center">
          ...
          {meReady && <div className="py-3 rounded-xl bg-emerald-500/8 border border-emerald-500/15"><span className="text-sm font-body text-emerald-400">{p1?.isReady && p2?.isReady ? 'Оба готовы! Генерация Captain\'s Mode...' : 'Ждём соперника...'}</span></div>}
