      ...
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="rounded-2xl bg-dota-card border border-dota-border p-6 space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 rounded-xl bg-dota-bg border border-dota-border text-white font-body text-sm placeholder:text-slate-600 focus:border-dota-accent/50 focus:outline-none transition-colors"
                />
              </div>
            </div>
          )}
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 rounded-xl bg-gradient-to-r from-dota-accent to-red-700 text-white font-body font-bold text-sm shadow-lg shadow-dota-accent/20 hover:shadow-dota-accent/40 hover:scale-[1.02] disabled:opacity-50 disabled:hover:scale-100 transition-all"
          >
