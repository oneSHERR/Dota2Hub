...
import { Swords, BookOpen, HelpCircle, ChevronRight, Zap, Shield, Target, ScrollText, TrendingUp, Trophy, Crown, Brain } from 'lucide-react';
import { ALL_HEROES, META_HEROES } from '@/data/heroes';

const FEATURES = [
  { icon: Swords, title: 'Draft Arena', desc: '1v1 с друзьями или Solo Drafter против AI. Анализ драфта с оценкой S/A/B/C/D.', link: '/draft', color: 'from-red-500 to-orange-600', glow: 'shadow-red-500/20' },
  { icon: BookOpen, title: 'Wiki + Гайды', desc: 'Контрпики, синергии, предметы и советы по фазам игры для 15+ героев.', link: '/wiki', color: 'from-blue-500 to-cyan-500', glow: 'shadow-blue-500/20' },
  { icon: Trophy, title: 'Тир-лист', desc: 'Рейтинг героев S/A/B/C/D по позициям. Винрейт, пикрейт, тренды.', link: '/tierlist', color: 'from-amber-500 to-yellow-600', glow: 'shadow-amber-500/20' },
  ...
  { icon: ScrollText, title: 'Патч 7.41b', desc: 'Все изменения героев и предметов в актуальном патче на русском.', link: '/patch', color: 'from-rose-500 to-pink-600', glow: 'shadow-rose-500/20' },
];
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center px-4">
        ...
        <div className="relative z-10 text-center max-w-4xl">
          <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-dota-accent/10 border border-dota-accent/20 mb-8 backdrop-blur-sm">
            ...
            <span className="text-xs font-body text-dota-accent tracking-wider uppercase font-medium">Solo Drafter · Тир-лист · Лидерборд — НОВОЕ</span>
          </div>
