...
const FEATURES = [
  ...
  { icon: Gamepad2, title: 'Мини-игры', desc: '8 игр: Инвокер, хук Пуджа, добивание крипов, угадай героя и другие.', link: '/minigames', color: 'from-fuchsia-500 to-pink-600', glow: 'shadow-fuchsia-500/20' },
];
