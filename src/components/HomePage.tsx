...
import { Swords, BookOpen, HelpCircle, ChevronRight, Zap, Shield, Target, ScrollText, TrendingUp, Crown } from 'lucide-react';
...
const FEATURES = [
  ...
  { icon: BookOpen, title: 'Wiki героев', desc: 'Контрпики, синергии, способности и матчапы для всех 128 героев. Данные из OpenDota API.', link: '/wiki', color: 'from-blue-500 to-cyan-500', glow: 'shadow-blue-500/20' },
  { icon: Crown, title: 'Тир-лист', desc: 'Рейтинг героев на основе STRATZ API. Винрейт и пикрейт в высоком рейтинге (Divine+).', link: '/tierlist', color: 'from-amber-500 to-yellow-600', glow: 'shadow-amber-500/20' },
  ...
  { icon: ScrollText, title: 'Патч 7.41b', desc: 'Все изменения героев и предметов в актуальном патче на русском.', link: '/patch', color: 'from-purple-500 to-fuchsia-600', glow: 'shadow-purple-500/20' },
];
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center px-4">
        ...
        <div className="relative z-10 text-center max-w-4xl">
          ...
          <p className="text-lg sm:text-xl text-slate-400 font-body max-w-2xl mx-auto mb-10 leading-relaxed">
            Драфт-арена, вики со способностями, STRATZ тир-лист и квизы — всё для того, чтобы побеждать
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            ...
            <Link to="/tierlist" className="flex items-center gap-2 px-10 py-4 rounded-xl bg-amber-500/10 border border-amber-500/20 text-amber-400 font-body font-semibold text-lg hover:bg-amber-500/20 backdrop-blur-sm transition-all duration-300">
              <Crown className="w-5 h-5" /> Тир-лист
            </Link>
