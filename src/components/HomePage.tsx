...
const FEATURES = [
  ...
  { icon: Crown, title: 'Тир-лист', desc: 'Рейтинг героев на основе OpenDota API. Винрейт и пикрейт по всем рангам.', link: '/tierlist', color: 'from-amber-500 to-yellow-600', glow: 'shadow-amber-500/20' },
  ...
  { icon: Gamepad2, title: 'Мини-игры', desc: 'Инвокер-тренажёр, матчапы 1v1 и Draft Puzzle — тренируйся и соревнуйся.', link: '/minigames', color: 'from-fuchsia-500 to-pink-600', glow: 'shadow-fuchsia-500/20' },
];
...
const STATS = [
  ...
  { icon: Crown, value: 'S→D', label: 'Тир-лист' },
];
    ...
    <div className="relative overflow-hidden">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center px-4">
        ...
        <div className="relative z-10 text-center max-w-4xl">
          <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-dota-accent/10 border border-dota-accent/20 mb-8 backdrop-blur-sm">
            ...
            <span className="text-sm font-body text-dota-accent tracking-wider uppercase font-semibold">v3 · Патч 7.41b · OpenDota API</span>
          </div>
          ...
          <p className="text-lg sm:text-xl text-slate-400 font-body max-w-2xl mx-auto mb-10 leading-relaxed">
            Драфт-арена, вики со способностями, тир-лист, калькулятор контрпиков и квизы
          </p>
      ...
      <footer className="border-t border-dota-border/30 py-8 px-4">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs font-body text-slate-600">Dota 2 is a registered trademark of Valve Corporation. Data from OpenDota.</p>
