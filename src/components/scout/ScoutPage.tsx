  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="max-w-5xl mx-auto px-4 pb-16">
        {/* Search bar */}
        <div className="sticky top-0 z-20 bg-[#0a0e13]/95 backdrop-blur-md py-4 -mx-4 px-4 mb-6">
          <div className="flex gap-3">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-12 pr-10 py-3.5 rounded-xl bg-[#111827] border border-white/10 text-white font-body text-base placeholder:text-slate-600 focus:border-dota-gold/30 focus:outline-none transition-colors"
              />
              {query && (
            ...
            <button
              ...
              className="px-8 py-3.5 rounded-xl bg-gradient-to-r from-dota-gold/80 to-amber-600 text-white font-body font-bold text-base hover:scale-[1.02] disabled:opacity-40 transition-all shadow-lg shadow-dota-gold/10"
            >
        ...
        {searchResults.length > 0 && !profile && (
          <div className="rounded-2xl bg-[#111827] border border-white/5 p-5 mb-6">
            ...
            <div className="space-y-2">
              {searchResults.map(r => (
                <button key={r.account_id} onClick={() => loadPlayer(r.account_id)}
                  className="w-full flex items-center gap-4 p-3 rounded-xl bg-white/3 hover:bg-white/6 transition-colors text-left">
                  <img src={r.avatarfull} alt="" className="w-12 h-12 rounded-xl border border-white/10" />
        ...
        {profile && !loading && (
          <>
            {/* Profile card */}
            <div className="rounded-2xl bg-gradient-to-br from-[#111827] to-[#0d1117] border border-white/5 p-6 mb-6">
              <div className="flex items-center gap-5">
                <img src={profile.profile.avatarfull} alt="" className="w-20 h-20 rounded-2xl border-2 border-white/10 shadow-xl" />
                <div className="flex-1 min-w-0">
                ...
                <button onClick={resetSearch} className="p-2 rounded-lg bg-white/5 hover:bg-white/10 transition-colors">
            ...
            <div className="flex gap-1 mb-6 p-1 rounded-xl bg-[#111827] border border-white/5 w-fit">
              {[
                ...
                <button key={key} onClick={() => setTab(key)}
                  className={`flex items-center gap-2 px-5 py-3 rounded-lg text-base font-body font-bold transition-all ${
            ...
            {tab === 'heroes' && (
              <div className="space-y-2">
                ...
                {topHeroes.map((h, i) => (
                  <div key={h.hero_id} className={`flex items-center gap-4 p-3 rounded-xl transition-all hover:bg-white/5 ${
                    i < 3 ? 'bg-[#111827] border border-dota-gold/15' : 'bg-[#111827]/60 border border-white/3'
                  }`}>
                    ...
                    <img src={h.hero!.img} alt="" className="w-16 h-10 rounded-lg object-cover border border-white/10" />
                    ...
                    <div className="flex items-center gap-6">
                      ...
                      <div className="w-20 h-2 rounded-full bg-white/5 overflow-hidden hidden sm:block">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                  {signatureHeroes.map((h, i) => (
                    <div key={h.heroId} className={`rounded-xl overflow-hidden border transition-all hover:scale-[1.02] ${
                      ...
                      <div className="relative h-20 overflow-hidden">
                        ...
                        {i < 3 && (
                          <div className="absolute top-2 right-2 w-7 h-7 rounded-lg bg-dota-gold/80 flex items-center justify-center">
            ...
            {tab === 'recent' && (
              <div className="space-y-2">
                ...
                {enrichedRecent.map(m => (
                  <div key={m.match_id} className={`flex items-center gap-4 p-3 rounded-xl border ${
                    ...
                    {m.hero && (
                      <>
                        <img src={m.hero.img} alt="" className="w-14 h-9 rounded-lg object-cover border border-white/10" />
                        <div className="flex-1 min-w-0">
                    ...
                    <a href={`https://www.opendota.com/matches/${m.match_id}`} target="_blank" rel="noopener"
                      className="p-2 rounded-lg bg-white/3 hover:bg-white/6 transition-colors">
        ...
        {!profile && !loading && !error && searchResults.length === 0 && (
          <div className="rounded-2xl bg-[#111827] border border-white/5 p-16 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3 text-sm font-body text-slate-500">
              <span className="px-3 py-1.5 rounded-lg bg-white/3">🔍 Поиск по нику</span>
              <span className="px-3 py-1.5 rounded-lg bg-white/3">🆔 Steam ID</span>
              <span className="px-3 py-1.5 rounded-lg bg-white/3">📊 Топ героев</span>
              <span className="px-3 py-1.5 rounded-lg bg-white/3">🎯 Последние 100 игр</span>
            </div>
          </div>
        )}
      </div>
